...
export default function Signup() {
    ...
    return (
        <section className="flex justify-center min-h-screen items-center px-4 sm:px-6 lg:px-8">
            <div className="bg-green-200 text-center p-6 sm:p-6 md:p-8 lg:p-8 m-2 sm:m-4 md:m-6 lg:m-8 w-full sm:w-auto max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl rounded-lg">
                <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-3 sm:mb-4">Book Management</h2>
                <div className="w-full flex justify-center">
                    <div className="bg-green-800 text-center w-full max-w-sm p-6 sm:p-8 md:p-10 rounded-2xl flex flex-col items-center">
                        <form onSubmit={handleSignup}>
                            ...
                            <Link to="/login" className="text-white animate-bounce underline">already have a account? Login</Link>
